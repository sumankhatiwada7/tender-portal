...
import { createuser, getAdminOverview, getAdminPayments, getallusers,getPendingUsers,approvedUser,rejectUser } from './admin.controller';
...
router.get("/overview", authMiddleware, authorizeRoles(roles.admin), getAdminOverview);
router.get("/payments", authMiddleware, authorizeRoles(roles.admin), getAdminPayments);
